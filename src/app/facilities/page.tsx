...
import { ArrowLeft, MapPin, Users, Utensils, Navigation, Info, X, Check, Sparkles, QrCode, Coffee, Flag } from 'lucide-react';
...
export default function FacilitiesPage() {
  ...
  const startNavigation = (mapsUrl: string) => {
                  ...
                  <div className="flex-1 p-6 flex flex-col justify-between space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-3 pt-2">
                      ...
                      <Button 
                        ...
                        onClick={() => startNavigation(facility.mapsUrl)}
                      >
