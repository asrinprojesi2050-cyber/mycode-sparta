...
export default function ParkingPage() {
  ...
  const fetchData = async () => {
    try {
      ...
      // Eğer bir otopark seçiliyse, verilerini güncel listeden bulup güncelle
      if (selectedLot) {
  ...
  useEffect(() => {
    fetchData();
    const interval = setInterval(fetchData, 15000); // 15 saniyede bir canlı güncelleme
      ...
      <main className="px-6 pt-6 animate-fade-in space-y-6 max-w-md mx-auto">
        {loading && !parkingLots ? (
          ...
          <div className="space-y-8 animate-in slide-in-from-right-5 duration-300">
            ...
            {/* Kat Bilgisi - Rose & Broken White Tasarımı */}
